...
bool btPrimitiveTriangle::triangle_triangle_distance(const btPrimitiveTriangle& b, btScalar& dist_sq_out, btVector3& a_closest_out, btVector3& b_closest_out, btScalar max_distance_sq)
{
																   ...
																   const btPrimitiveTriangle& thisBackup, const btPrimitiveTriangle& otherBackup, bool doUnstuck, bool isSelfCollision)
{
	...
	else if (ret && dist_sq_out == 0.0)
	{
		...
		if (doUnstuck)
		{
			...
			contacts.m_penetration_depth = -centroidDistSum;
		}
		else
		{
