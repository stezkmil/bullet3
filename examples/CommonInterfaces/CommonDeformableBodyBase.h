		...
		if (rayCallback.hasHit())
		{
			...
			else if (psb)
			{
				...
				if (face_id >= 0 && face_id < psb->m_faces.size())
				{
					...
					btDeformableMousePickingForce* mouse_force = new btDeformableMousePickingForce(m_pickingForceElasticStiffness, m_pickingForceDampingStiffness, &f, nullptr, nullptr, m_hitPos, m_maxPickingForce);
